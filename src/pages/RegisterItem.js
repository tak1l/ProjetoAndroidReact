        ...
        <View>
            ...
            <View  style={[stylesList.card, styles.cardCreat, stylesNavbar.shadow]}>
                <View style={[stylesNavbar.navbar, {marginTop: 0, paddingStart: 10}]}>
                    <Text style={[stylesNavbar.nickname, {fontSize: 16, fontWeight: '#fff'}]}>Descrição </Text>
                    <TextInput 
                ...
                <Text style={[styles.nomenclatura, {marginTop: 10}]}>Método Pagamento:</Text> 
                <Picker
                ...
                >  
                    <Picker.Item  label='Opções' value='' />
                    <Picker.Item  label='Crédito' value='5dcd550410cf97682b4e15c7' />
                    <Picker.Item  label='Débito' value='5dcd550a10cf97682b4e15c8' />
